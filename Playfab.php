    ...
    class Playfab {
        ...
        */
        ...
        public function last_x_minute_calls_per_second(int $minutes = 2): int
        {
            ...
            $this->sql_exec($sql);
            return $this->results(first_result_only: true)['calls_per_second'];
        }
         ...
         * @return string
         */
        protected function last_endpoint_call(string $endpoint): string
        {
        ...
        public function last_updated_depricated(string $endpoint): string
        {
            return $this->last_endpoint_call(endpoint: $endpoint);
        }
        ...
        */
         ...
         * @return string
         */
        protected function make_rest_call(string $endpoint, array $headers = [], array $params = [], string $method = "POST"): stdClass
        {
            // API call auditing
            $this->call_limiter();
...
//            var_dump();
        ...
        */
        ...
        public function get_characters(string $playFabId = null): string
        {
            ...
            return $this->make_rest_call(endpoint: ENDPOINT_GET_USER_CHARS, headers: $headers, params: $params);
        }
        ...
        public function get_character_stats(string $characterId = null): string
        {
            ...
            return $this->make_rest_call(endpoint: ENDPOINT_GET_CHAR_STATS, headers: $headers, params: $params);
        }
